...
if [[ "$OSTYPE" == "darwin"* ]]; then
    ...
    curl -Lo "ctrdecrypt-macos-universal.zip" "https://github.com/shijimasoft/ctrdecrypt/releases/download/v${CTRDECRYPT_VER}/ctrdecrypt-macos-universal.zip"
    ...
    if [[ $(uname -m) == 'arm64' ]]; then
        ...
        curl -Lo "ctrtool-v${CTRTOOL_VER}-macos_arm64.zip" "https://github.com/3DSGuy/Project_CTR/releases/download/ctrtool-v${CTRTOOL_VER}/ctrtool-v${CTRTOOL_VER}-macos_arm64.zip"
        ...
        curl -Lo "makerom-v${MAKEROM_VER}-macos_arm64.zip" "https://github.com/3DSGuy/Project_CTR/releases/download/makerom-v${MAKEROM_VER}/makerom-v${MAKEROM_VER}-macos_arm64.zip"
    ...
    # x86_64
        ...
        echo " * Downloading ${BOLD}ctrtool${NORMAL}"
        curl -Lo "ctrtool-v${CTRTOOL_VER}-macos_x86_64.zip" "https://github.com/3DSGuy/Project_CTR/releases/download/ctrtool-v${CTRTOOL_VER}/ctrtool-v${CTRTOOL_VER}-macos_x86_64.zip"
        echo " * Extracting ${BOLD}ctrtool${NORMAL}"
        ...
        echo " * Downloading ${BOLD}makerom${NORMAL}"
        curl -Lo "makerom-v${MAKEROM_VER}-macos_x86_64.zip" "https://github.com/3DSGuy/Project_CTR/releases/download/makerom-v${MAKEROM_VER}/makerom-v${MAKEROM_VER}-macos_x86_64.zip"
        echo " * Extracting ${BOLD}makerom${NORMAL}"
...
# Linux (x86_64)
    ...
    echo " * Downloading ${BOLD}ctrdecrypt${NORMAL}"
    curl -Lo "ctrdecrypt-linux-x86_64.zip" "https://github.com/shijimasoft/ctrdecrypt/releases/download/v${CTRDECRYPT_VER}/ctrdecrypt-linux-x86_64.zip"
    echo " * Extracting ${BOLD}ctrdecrypt${NORMAL}"
    ...
    echo " * Downloading ${BOLD}ctrtool${NORMAL}"
    curl -Lo "ctrtool-v${CTRTOOL_VER}-ubuntu_x86_64.zip" "https://github.com/3DSGuy/Project_CTR/releases/download/ctrtool-v${CTRTOOL_VER}/ctrtool-v${CTRTOOL_VER}-ubuntu_x86_64.zip"
    echo " * Extracting ${BOLD}ctrtool${NORMAL}"
    ...
    echo " * Downloading ${BOLD}makerom${NORMAL}"
    curl -Lo "makerom-v${MAKEROM_VER}-ubuntu_x86_64.zip" "https://github.com/3DSGuy/Project_CTR/releases/download/makerom-v${MAKEROM_VER}/makerom-v${MAKEROM_VER}-ubuntu_x86_64.zip"
    echo " * Extracting ${BOLD}makerom${NORMAL}"
...
if [[ ! -f "seeddb.bin" ]]; then
    ...
    curl -Lo "seeddb.bin" "https://github.com/ihaveamac/3DS-rom-tools/raw/master/seeddb/seeddb.bin"
fi
